...
export const Preview = ({ value, fontSize, images }: PreviewProps) => {
  if (!value.trim()) {
    return (
      <div className="flex items-center justify-center min-h-full text-zinc-400 dark:text-zinc-400">
        <div className="text-center">
          ...
          <p className="text-sm font-light">Start writing to see preview</p>
        </div>
      </div>
    );
  }

  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        onChange={onChange}
        onPaste={handlePaste}
        className="w-full min-h-full px-4 sm:px-10 py-4 sm:py-6 font-mono leading-relaxed text-stone-700 dark:text-zinc-300 bg-transparent border-none resize-none outline-none placeholder:text-stone-300 dark:placeholder:text-zinc-600 selection:bg-blue-200 dark:selection:bg-blue-500/30"
